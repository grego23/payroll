...
hr{
	...
	@endforeach
					...
					<hr>
				<h4 style="font-family: Arial, Helvetica, sans-serif;">Employees Payroll Month Of {{$date}} </h4>
					<hr>
		<p>
		...
		<tr><th>Month: </th><th>Empoyee Id:</th><th>First Name </th><th>Last Name:</th><th>Personal relief: </th><th>Insurance relief: </th>
...
+$datas->nssf+$datas->hosp+$datas->occupier_interest+$datas->disability_excemption}}.00</td>
<td>{{$x=$datas->salary*$datas->tax/100}}.00 </td>
<td>{{$total=$datas->salary -  $b=$datas->salary*$datas->tax/100 + $a=$datas->personal_relief+$datas->insurance_relief+$datas->pension_fund+$datas->nhif_deduction
+$datas->nssf+$datas->hosp+$datas->occupier_interest+$datas->disability_excemption  }}.00</td>
			</tr>	
			@endforeach
				<tr>
