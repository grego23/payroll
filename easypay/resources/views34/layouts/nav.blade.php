                ...
                <ul class="nav pcoded-inner-navbar">
                   ...
                   <!-- <li data-username="advance components Alert gridstack lightbox modal notification pnotify rating rangeslider slider syntax highlighter Tour Tree view Nestable Toolbar" class="nav-item pcoded-hasmenu">
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                     ...
                     <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="{{route('deduction.create')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Deductions</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{route('deduction.create')}}" class=""><span class="pcoded-micon"><i class="feather icon-folder"></i></span>Add Deduction</span></a>
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="{{route('deduction.create')}}" class="" target="_blank">Add Here</a></li>
					        ...
					        <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="{{URL::to('getpay')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file"></i></span><span class="pcoded-mtext">Payroll</span></a>
                        <ul class="pcoded-submenu">
                    ...
                    <li data-username="Sample Page" class="nav-item"><a href="{{URL::to('getpay')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Payroll Reports</span></a></li>
