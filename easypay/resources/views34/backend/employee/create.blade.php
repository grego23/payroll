...
<a class="btn btn-success" href="{{ route('employee.edit',$info->id) }}">Edit</a>
...
@endif
                                            ...
                                            <div id="smartwizard">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" id="date-format" class="form-control" placeholder=""  name="dob" required>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                  ...
                                                  <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="account-name"  name="accname" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="account-number">Account No.</label>
                                                        <input type="text" class="form-control" id="account-number" name="accnumber" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="bank-branch" name="bankbranch" required>
                                                    </div>
                                            ...
                                            <h5>Deductions</h5>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label for="first-name">First Name</label>
                                                        <input type="text" class="form-control" id="first-name" name="kname" required>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="last-name">Last Name</label>
                                                        <input type="text" class="form-control" id="last-name" name="klast" required>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-7">
                                                        ...
                                                        <input type="text" class="form-control" id="email" name="k_email" required>
                                                    </div>
                                                    <div class="form-group col-md-5">
                                                        <label for="phone-number">Phone No.</label>
                                                        <input type="text" class="form-control" id="phone-number" name="k_phone" required>
                                                    </div>
