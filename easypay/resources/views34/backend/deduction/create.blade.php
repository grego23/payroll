...
<th>Tax</th><th>Nhif</th><th>X</th><th>X</th><th>X</th>
</tr>
</thead>
<tbody>
...
<a class="btn btn-primary" href=""><i class="feather icon-edit"></i>View</a>
...
<a class="btn btn-danger" href=""><i class="feather icon-edit"></i>Delete</a>
									 ...
									 {{ Form::open(['route' => 'deduction.store', 'files' => true,'role'=>'form']) }}
                                             ...
                                             <option value="1000">40,000 - 44,999</option>
                                                ...
                                                <div class="col-md-6">
                                                      ...
                                                      <option value="3000"> (i) Up to - 6000</option>
                                                      
                                                  <option value="800"> (ii)  6001 - 18000</option>
