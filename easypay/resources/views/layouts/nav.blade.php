...
@if(auth::user()->level==1)
    ...
    <nav class="pcoded-navbar menu-light brand-lightblue icon-colored">
        <div class="navbar-wrapper ">
            <div class="navbar-brand header-logo">
                <a href="{{URL::to('admin')}}" class="b-brand">
                         <div class="b-bg">
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item pcoded-hasmenu active pcoded-trigger">
                        <a href="{{URL::to('/admin')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{URL::to('admin')}}" class=""><span class="pcoded-micon"><i class="feather icon-info"></i></span>Home</span></a></li>
                    ...
                    <li data-username="advance components Alert gridstack lightbox modal notification pnotify rating rangeslider slider syntax highlighter Tour Tree view Nestable Toolbar" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{URL::to('showusers')}}" class="">List Users</a></li>
                            <li class=""><a href="{{URL::to('showusers')}}" class="">Register User</a></li>
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{URL::to('showcompany')}}" class=""><span class="pcoded-micon"><i class="feather icon-user"></i></span>View Companies</span></a>
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Employees</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{URL::to('showemployees')}}" class=""><span class="pcoded-micon"><i class="feather icon-users"></i></span>View Employees</span></a>
    ...
    <!-- [ Header ] start -->
    <header class="navbar pcoded-header navbar-expand-lg navbar-light"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <div class="m-header">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                 <a href="getprofile/{{Auth::user()->id}}" style="color:white !mportant;" > 
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item pcoded-hasmenu active pcoded-trigger">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{URL::to('dashboard')}}" class=""><span class="pcoded-micon"><i class="fas fa-home"></i></span>Home</span></a></li>
                           <!--<li class=""><a href="dashboard-ecommerce.html" class="">Ecommerce</a></li>
                            <li class=""><a href="dashboard-crm.html" class="">CRM</a></li>
                            <li class="active"><a href="dashboard-analytics.html" class="">Analytics</a></li>
                            <li class=""><a href="dashboard-crypto.html" class="">Crypto<span class="pcoded-badge label label-danger">NEW</span></a></li>
                   ...
                   <!-- <li data-username="advance components Alert gridstack lightbox modal notification pnotify rating rangeslider slider syntax highlighter Tour Tree view Nestable Toolbar" class="nav-item pcoded-hasmenu">
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Organizations</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{route('company.create')}}" class=""><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span>Add Organization</span></a>
                                <ul class="pcoded-submenu">
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Employees</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{route('employee.create')}}" class=""><span class="pcoded-micon"><i class="feather icon-user"></i></span>Add Employee</span></a>
                               
                            </li>
                            <li class="pcoded-hasmenu"><a href="{{URL::to('importExportView')}}" class=""><span class="pcoded-micon"><i class="feather icon-user"></i></span>Import Employees</span></a>
                     ...
                     <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Deductions</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{route('deduction.create')}}" class=""><span class="pcoded-micon"><i class="feather icon-user"></i></span>Add Deduction</span></a>
					    ...
					    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Bonuses</span></a>
                        <ul class="pcoded-submenu">
                            <li class="pcoded-hasmenu"><a href="{{route('bonus.create')}}" class=""><span class="pcoded-micon"><i class="feather icon-user"></i></span>Add Bonus</span></a>
                    ...
                    <li data-username="Sample Page" class="nav-item"><a href="{{URL::to('getpay')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Process Payroll</span></a></li>
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-file"></i></span><span class="pcoded-mtext">Statutory Reports</span></a>
                        <ul class="pcoded-submenu">
                          
                    </li>

                    <li data-username="Sample Page" class="nav-item"><a href="{{URL::to('getNhif')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-folder"></i></span><span class="pcoded-folder">Nhif Reports</span></a></li>
                    <li data-username="Sample Page" class="nav-item"><a href="{{URL::to('getNssf')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Nssf Reports</span></a></li>
<li data-username="Sample Page" class="nav-item"><a href="" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Kra Reports</span></a></li>
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="" class="">Session timeout</a></li>
                            <li class=""><a href="" class="">Session idle timeout</a></li>
                            <li class=""><a href="" class="">Offline</a></li>
                            <li><a href="{{ route('logout') }}" class="dropdown-item"><i class="feather icon-lock"></i> Logout</a></li>
                        </ul>
                    </li>
