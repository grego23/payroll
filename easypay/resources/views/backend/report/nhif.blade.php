                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Nhif Reports</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="organizations.html">Nhif</a></li>
                                        <li class="breadcrumb-item"><a href="company-info.html">Reports</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
								   ...
								   <div class="col-md-12 col-xl-12">
                                    <div class="card user-card">
                                       ...
                                       <h3><small class="label theme-bg text-white f-12 f-w-900"> Date:{{$date}}</small></h3>
                                        ...
                                        <div class="col-md-4">
                                        <a class="btn btn-success" href="{{URL::to('get_nhif_report_pdf') }}" style=""><i class="feather icon-settings"></i>Process Nhif Report</a>
                                        </div>
                                        <div class="col-md-4">
                                        <a class="btn btn-primary" href="{{URL::to('exportnhif') }}" style=""><i class="feather icon-download"></i>Download Excel Nhif Report</a>
                                        </div>
                                        </div>
...
<th>Nhif Number</th><th>Amount</th>
</tr>
</thead>
<tbody>
