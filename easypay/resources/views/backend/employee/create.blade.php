                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="organizations.html">Employee</a></li>
                                        <li class="breadcrumb-item"><a href="company-info.html">Employee Information</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<td> <a href="{{ route('employee.show', $info->id)}}" class="btn btn-primary"><i class="feather icon-eye"></i> View</a></td>
                                            ...
                                            <div id="smartwizard">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" id="datepicker2" class="form-control" placeholder=""  name="dob" required>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" id="datepicker3" class="form-control" placeholder=""  name="emp_date" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" class="form-control number" id="account-name" name="salary" placeholder ="eg 50000" onchange="addCommas" required>
                                                    </div>
