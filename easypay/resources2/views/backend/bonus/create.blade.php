...
<a class="btn btn-primary" href=""><i class="feather icon-eye"></i>View</a>
...
<a class="btn btn-danger" href=""><i class="feather icon-trash"></i>Delete</a>
                                                ...
                                                @endforeach                
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="reason" placeholder="reason" id="kra" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Amount</label>
                                                            <input type="text" class="form-control" name="amount" placeholder="amount" id="kra" required>
                                                        </div>
                                                    </div>
