...
Route::get('getprofile/{id}', 'ProfileController@getUser');
Route::post('postajax',['as'=>'postajax','uses'=>'CompanyController@ajax']);
Route::post('testAjax',['as'=>'testAjax','uses'=>'PositionController@ajax']);
Route::post('processroll',['as'=>'processroll','uses'=>'PayrollController@processroll']);
...
Route::post('updateimage',['as'=>'updateimage','uses'=>'CompanyController@updateImage']);
Route::post('newprofile',['as'=>'newprofile','uses'=>'ProfileController@updateImage']);
Route::post('updatepass',['as'=>'updatepass','uses'=>'ProfileController@updatePass']);
